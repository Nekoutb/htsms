...
final readonly class MessageSubmissionService
{
    ...
    public function submit(Organization $organization, string $recipient, string $body, ?DateTimeInterface $scheduledAt, ?DateTimeInterface $expiresAt, ?string $idempotencyKey, string $source): SubmittedMessage
    {
        return DB::transaction(function () use ($organization, $recipient, $body, $scheduledAt, $expiresAt, $idempotencyKey, $source): SubmittedMessage {
