...
Route::middleware(['auth', 'verified'])->group(function (): void {
    ...
    Route::delete('/app/{organization}/devices/{device}/delete', [PortalController::class, 'deleteDevice'])->name('portal.devices.delete');
    ...
    Route::delete('/app/{organization}/developer/api-keys/{apiKey}/delete', [PortalController::class, 'deleteApiKey'])->name('portal.api-keys.delete');
    ...
    Route::delete('/app/{organization}/developer/webhooks/{webhookEndpoint}/delete', [PortalController::class, 'deleteWebhook'])->name('portal.webhooks.delete');
    Route::get('/app/{organization}/settings', [SettingsController::class, 'show'])->name('portal.settings');
    Route::post('/app/{organization}/settings/profile', [SettingsController::class, 'updateProfile'])->name('portal.settings.profile');
    Route::post('/app/{organization}/settings/workspace', [SettingsController::class, 'updateWorkspace'])->name('portal.settings.workspace');
    Route::delete('/app/{organization}/settings/workspace', [SettingsController::class, 'destroyWorkspace'])->name('portal.settings.workspace.delete');
